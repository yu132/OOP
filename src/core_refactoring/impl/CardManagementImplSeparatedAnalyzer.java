...
public class CardManagementImplSeparatedAnalyzer implements CardManagement{
	...
	private SeparatedCardGameAnalyzer tipsGetter;
	
	private String lastMove="";
	
	private Map<Components,Component> map=new HashMap<>();
	
	public CardManagementImplSeparatedAnalyzer(Dealer dealer, Box box_1, Box box_2, Box box_3, Box box_4, CardHeap cardHeap_1,
			CardHeap cardHeap_2, CardHeap cardHeap_3, CardHeap cardHeap_4, CardHeap cardHeap_5, CardHeap cardHeap_6,
			CardHeap cardHeap_7, PointCounter pointCounter, SeparatedCardGameAnalyzer tipsGetter) {
		super();
		this.dealer = dealer;
		this.box_1 = box_1;
		this.box_2 = box_2;
