...
public class CardManagementImplBindingAnalyzer implements CardManagement{
	...
	public CardManagementImplBindingAnalyzer(Dealer dealer, Box box_1, Box box_2, Box box_3, Box box_4, CardHeap cardHeap_1,
			...
			CardHeap cardHeap_7, PointCounter pointCounter, BindingCardGameAnalyzer tipsGetter) {
		super();
		this.dealer = dealer;
		this.box_1 = box_1;
		this.box_2 = box_2;
